...
function toggleJS(call) {
	chrome.contentSettings['javascript'].get({primaryUrl:'https://discord.com/'},function(details) {
	chrome.contentSettings['javascript'].set({primaryPattern: '*://discord.com/*', setting:call})});
}
function create() {
